...
export async function test(name, email) {
...
export async function update(cardHolderId, cardId) {
...
export async function payWithVirtualCard(cardId, amount) {
    ...
    //     authorization.id
    //   );
    const authorizationpayment = await stripe.testHelpers.issuing.authorizations.capture(authorization.id);
